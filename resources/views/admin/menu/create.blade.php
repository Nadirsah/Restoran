...
<div class="content">
    ...
    <!-- Basic tabs -->
    <form action="{{route('admin.menu.store')}}" method="POST" class="row" enctype="multipart/form-data">
        @csrf
        <div class="col-md-5">
            <div class="card">
                <div class="card-body">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <fieldset class="content-group">
                                                    <div class="form-group">
                                                        <label>Title</label>
                                                        <input class="form-control" name="name[{{$lang->name}}]" value="{{old('name.'.$lang->name)}}" placeholder="Title">
                                                        <span class="text-danger">@error('name.'.$lang->name){{'Title sahəsi boş ola bilməz!'}}@enderror</span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Təsvir</label>
                                                        <input class="form-control" name="description[{{$lang->name}}]" value="{{old('name.'.$lang->name)}}" placeholder="Təsvir">
