...
<div class="content">
    ...
    <!-- Basic tabs -->
    <form action="{{route('admin.navbar.update',$data->id)}}" method="POST" class="row" enctype="multipart/form-data">
        @method("PUT")
        @csrf
        <div class="col-md-5">
            <div class="card">
                    ...
                    <div class="tab-content">
                        <div class="card">
                            <div class="card-body">
                                            ...
                                            <div class="card-body">
                                                <fieldset class="content-group">
                                                    <div class="form-group">
                                                        <label>Başlıq</label>
                                                        <input type="text" class="form-control " name="title[{{$lang->name}}]" value="{{old('title.'.$lang->name,$data->getTranslation('title',$lang->name))}}"
                                                            placeholder="Yazin...">
                                                        <span
                                                    ...
                                                    <div class="form-group">
                                                        <label>Text</label>
                                                        <input type="text" class="form-control " name="text[{{$lang->name}}]" value="{{old('text.'.$lang->name,$data->getTranslation('text',$lang->name))}}"
                                                            placeholder="Yazin...">
                                                        <span
                                ...
                                <div class="form-group">
                                    <label>picture</label>
                                    <input type="file" class="form-control " name="background_image" value="{{$data->background_image}}"
                                        placeholder="Yazin...">
                                    <span
