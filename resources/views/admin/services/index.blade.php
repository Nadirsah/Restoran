...
<div class="content">
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            ...
            <h5 class="card-title"><a href="{{route('admin.services.create')}}" class="btn btn-info"><i
                        class="icon-plus3 mr-3 icon-xl"></i> Xidmət əlavə et</a></h5>
        ...
        <table class="table table-hover border table-bordered" id="dataTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <a href="{{route('admin.services.edit',$items->id)}}"><i class="btn btn-info fa fa-edit"></i></a>
